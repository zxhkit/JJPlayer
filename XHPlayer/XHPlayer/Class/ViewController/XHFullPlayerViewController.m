...
@interface XHFullPlayerViewController ()
...
@implementation XHFullPlayerViewController
...
- (void)setupUI
{
    ...
    //设置遮罩层
    self.maskView = [[XHVideoMaskView alloc] initWithFrame:self.playerView.bounds];
