...
typedef void (^VideoPlayerControllerPlayBtnClick)(void);
...
@interface XHVideoPlayerView : UIView
...
/** 播放回调 */
@property (nonatomic, copy) VideoPlayerControllerPlayBtnClick playBlock;
/** 播放完成回调 */
