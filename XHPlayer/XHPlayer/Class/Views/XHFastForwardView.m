...
@implementation XHFastForwardView
...
- (void)setProgress:(CGFloat)progress{
    ...
    [self.progressLabel setText:[NSString stringWithFormat:@"%@/%@",[XHVideoTimeUtil hmsStringWithFloat:self.currentDuration],[XHVideoTimeUtil hmsStringWithFloat:self.maxDuration]]];
}
